    ...
    <div class="main-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-icon"><img src="../assets/images/hourglass.png" alt="Hours"></div>
                    <div class="stat-details">
                        <h3>Total Volunteer Hours</h3>
                        <p class="stat-number"><?php echo $total_volunteer_hours ?></p> </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon"><img src="../assets/images/star.png" alt="Points"></div>
                    <div class="stat-details">
                        <h3>Current Points</h3>
                        <p class="stat-number"><?php echo $current_points ?></p> </div>
                </div>
            </div>
                ...
                <form id="basic_form" class="profile-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row read-only-row">
                        <div class="form-group">
                            ...
                            <input type="text" value="STUDENT" disabled class="disabled-input">
                        </div>
                        <div class="form-group">
